...
exports.searchPosts = async (req, res) => {
  const { q, page = 1, limit = 10 } = req.query; // Termo de pesquisa e paginação
...
// Atualizar um post existente (apenas o próprio autor pode editar)
exports.updatePost = async (req, res) => {
  ...
  try {
    // Verificar se o post existe e pertence ao usuário atual
...
// Excluir um post (apenas o próprio autor pode excluir)
exports.deletePost = async (req, res) => {
  ...
  try {
    ...
    // Excluir o post (as exclusões em cascata cuidarão de likes, comentários e favoritos)
